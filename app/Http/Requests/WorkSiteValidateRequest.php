...
class WorkSiteValidateRequest extends FormRequest
{
    public function rules()
    {
        return [
            ...
            'site_address.*.street' => 'required_with:site_address|string|between:3,25',
            'site_address.*.house_number' => 'required_with:site_address|numeric|max_digits:5',
            'site_address.*.apartment_number' => 'nullable|numeric|max_digits:5',
